...
async function main() {
  ...
  let router_address = "0xe6ff8b9A37B0fab776134636D9981Aa778c4e718";//process.env.SWAP_ROUTER_V2;
  ...
  vault.on("Swap", (sender, recipient, amount0, amount1, sqrtPriceX96, liquidity,  tick, event) => {
    console.log(ethers.utils.parseUnits(amount0.toString(), 6));
    console.log(ethers.utils.parseUnits(amount1.toString(), 18));
    // try {
