...
contract IndexUpgradeable is IIndex, Filter, UUPSUpgradeable {
    ...
    function initialize(uint256 indexId,  string memory indexName, address[] calldata indexTokens) external initializer {
